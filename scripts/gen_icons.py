...
Output:
    puzzle.ico (sizes: 16, 24, 32, 48, 64, 128, 256)
    puzzle.icns (sizes: 16, 32, 48, 64, 128, 256, 512, 1024)
...
SVG_PATH = Path(__file__).resolve().parent.parent / "assets" / "icons" / "puzzle.svg"
