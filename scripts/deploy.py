...
PLATFORM_INCLUDE_PACKAGES: dict[str, list[str]] = {
    "win32": [
        "serial", "serial.tools.list_ports", "loguru"
    ],
}
...
def _icon_path() -> str | None:
    ...
    if sys.platform == "win32":
        p = PROJECT_ROOT / "assets" / "icons" / "puzzle.ico"
    elif sys.platform == "darwin":
        p = PROJECT_ROOT / "assets" / "icons" / "puzzle.icns"
    else:
        p = PROJECT_ROOT / "assets" / "icons" / "puzzle.png"
